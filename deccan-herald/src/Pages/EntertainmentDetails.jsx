...
import enter from "./EntertainmentDetails.module.css"
...
const EntertainmentDetails = () => {
  ...
  return (
    ...
    <div className={enter.enter_container}>
         <div>
    <Breadcrumb>
<BreadcrumbItem>
...
<BreadcrumbLink href='#'>Entertentment</BreadcrumbLink>
      ...
      <div  className={enter.enter_container1} >
      {enterDet.title}
      </div>
      <div  className={enter.enter_container2} >
      <FaRegUserCircle/> {enterDet.author}{", "}{enterDet.publishedAt}
      </div>
      <div  className={enter.enter_container3}>
        <img src={enterDet.urlToImage} alt="" style={{width:"100%"}} />
      </div>
      <div className={enter.enter_container4}>
