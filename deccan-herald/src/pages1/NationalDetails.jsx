...
import national from "./NationalDetails.module.css"
...
const BusinessDetails = () => {
  ...
  return (
    <div className={national.enter_container}>
         <div>
    <Breadcrumb>
<BreadcrumbItem>
...
<BreadcrumbLink href='#'>National</BreadcrumbLink>
      ...
      <div  className={national.enter_container1} >
      {enterDet.title}
      </div>
      <div  className={national.enter_container2} >
      <FaRegUserCircle/> {enterDet.author}{", "}{enterDet.publishedAt}
      </div>
      <div  className={national.enter_container3}>
        <img src={enterDet.urlToImage} alt="" style={{width:"100%"}} />
      </div>
      <div className={national.enter_container4}>
