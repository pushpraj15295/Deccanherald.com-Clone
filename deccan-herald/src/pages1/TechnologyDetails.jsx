...
import technology from "./TechnologyDetails.module.css"
...
const TechnologyDetails = () => {
  ...
  return (
    <div className={technology.enter_container}>
             <div>
    <Breadcrumb>
<BreadcrumbItem>
...
<BreadcrumbLink href='#'>Technology</BreadcrumbLink>
      ...
      <div  className={technology.enter_container1} >
      {enterDet.title}
      </div>
      <div  className={technology.enter_container2} >
      <FaRegUserCircle/> {enterDet.author}{", "}{enterDet.publishedAt}
      </div>
      <div  className={technology.enter_container3}>
        <img src={enterDet.urlToImage} alt="" style={{width:"100%"}} />
      </div>
      <div className={technology.enter_container4}>
