...
import business from "./BusinessDetails.module.css"
...
const BusinessDetails = () => {
  ...
  useEffect(()=>{
    axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6f43be9f49cf4702b914421834ff3c3e`)
    .then((r)=>{
  ...
  return (
    <div className={business.enter_container}>
          <div>
    <Breadcrumb>
<BreadcrumbItem>
...
<BreadcrumbLink href='#'>Business</BreadcrumbLink>
      ...
      <div  className={business.enter_container1} >
      {enterDet.title}
      </div>
      <div  className={business.enter_container2} >
      <FaRegUserCircle/> {enterDet.author}{", "}{enterDet.publishedAt}
      </div>
      <div  className={business.enter_container3}>
        <img src={enterDet.urlToImage} alt="" style={{width:"100%"}} />
      </div>
      <div className={business.enter_container4}>
